...
import { UpdateMissionForm } from "./forms/update-mission-form";
import { Mission, TempMission } from "@prisma/client";

export function UpdateMissionCard({
  mission,
  originalMissionId,
}: {
  mission: Mission | TempMission;
...
Begin by introducing yourself and asking about their business context and the general area they wish to research. Adapt your subsequent questions based on their responses to create a natural conversation flow while ensuring all essential aspects of marketing research planning are addressed.`);
  ...
  return (
    <Form {...form}>
      <AudiencesFilterProvider audiences={mission?.audiences}>
        <div className="flex-1 overflow-y-auto bg-white">
          <UpdateMissionForm
            inComingMission={mission}

...
export function HeaderTemplate({ template }: HeaderTemplateProps) {
  ...
  const addQuestionAI = useAction(addQuestionTemplateAIAction, {
    onSuccess: ({ data }) => {
      ...
      toast({
        title: t("surveys.saveDraftSuccess"),
        description: t("surveys.saveDraftSuccessDescription"),
      });
    },
    onError: () => {
      toast({
        title: t("surveys.saveDraftError"),
        description: t("surveys.saveDraftErrorDescription"),
        variant: "destructive",
      });
    },
  });
  ...
  const updateTemplate = useAction(updateTemplateAction, {
    onSuccess: () => {
      ...
      toast({
        title: t("templates.updateTemplateSuccess"),
        description: t("templates.updateTemplateSuccessDescription"),
      });
    },
    onError: () => {
      toast({
        title: t("templates.updateTemplateError"),
        description: t("templates.updateTemplateErrorDescription"),
        variant: "destructive",
      });
    },
  });
  ...
  const deleteTemplate = useAction(deleteTemplateAction, {
    onSuccess: () => {
      toast({
        title: t("templates.deleteTemplateSuccess"),
        description: t("templates.deleteTemplateSuccessDescription"),
      });
      router.push(`/templates`);
    },
    onError: () => {
      toast({
        title: t("templates.deleteTemplateError"),
        description: t("templates.deleteTemplateErrorDescription"),
        variant: "destructive",
      });
    },
  });

import type { ITheme, ImageFit } from "survey-core";
...
export const lightTheme: ITheme = {
  ...
  cssVariables: {
    ...
    "--sjs-primary-backcolor": "#FF5B4A",
    "--sjs-primary-backcolor-dark": "rgba(240, 86, 70, 1)",
    "--sjs-primary-backcolor-light": "rgba(255, 91, 74, 0.1)",

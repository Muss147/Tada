export default {
  common: {
    ...
    stepsDescription:
      "Complete missions of all types and get paid transparently.",
    ...
    testimonialsTitle: "What our contributors say:",
    testimonialsSubtitle:
      "Make money on your schedule, whether you’re working full-time or going to school.",

    // CTA Section
    ctaTitle1: "Become a contributor and",
    ctaTitle2: "start earning",
    ctaTitle3: "money.",
    ctaDescription: "Start making money with your knowledge.",

export default {
  common: {
    ...
    // Hero Section
    heroTitle1: "Make money",
    heroTitle2: "with your phone.",
    heroDescription:
      "Help improve the way businesses, governments, and organizations make decisions - by sharing your voice on the products and policies that affect you.",
    heroImageAlt: "Stylish man with money and sunglasses",

    // Partners Section
    partnersTitle: "They trust us",

    // Three Steps Section
    stepsTitle1: "Make money simply",
    ...
    step1Description:
      "Download our free app on iOS or Android and create an account using your email address to join Tada Contributor Community",

    step2Title: "Discover our tasks",
    step2Description:
      "Browse available tasks, select what fits you best, and get them done in no time.",

    step3Title: "Get paid",
    step3Description:
      "Choose to be paid instantly via Paypal or  Mobile Money according to your country.",

    // Global Demand Section
    globalDemandTitle: "Global demand, local supply.",
    globalDemandDescription:
      "Our AI-enhanced system coordinates a network of qualified mappers, collecting localized data quickly and efficiently.",
    contributorsAfrica: "Contributors across Africa",
    partnerCompanies: "Partner companies",
    salesPoints: "Contributors’ average earnings per month",
    citiesCovered: "Countries & territories covered",

    // Testimonials Section
    testimonials: {
      title: "What Our Contributors Say:",
      subtitle: "Earn money on your schedule, whether you are working full-time or a student.",
      items: [
        {
          role: "Economics Student",
          text: "I checked the availability and prices of spaghetti packets in supermarkets near me. It’s fast and complements my student income.",
        },
        {
          role: "Freelance Sales Agent",
          text: "I took inventory of energy drinks in several points of sale in Abidjan. It's simple and flexible.",
        },
        {
          role: "Security Guard",
          text: "After work, I take pictures of food product shelves in local shops. The app is easy to use.",
        },
        {
          role: "Motorcycle Delivery Driver",
          text: "I check the presence of advertising displays for a mobile brand in different points of sale during my breaks.",
        },
        {
          role: "Assistant Brand Manager",
          text: "In addition to my job, I evaluate the visibility of new biscuit packs in large stores, which enriches my understanding of the field.",
        },
        {
          role: "Call Center Agent",
          text: "I collect prices and promotions for hygiene products in various stores. It's an interesting complementary income.",
        },
        {
          role: "Marketing Student",
          text: "I participated in evaluation missions for soft drinks in several points of sale. The instructions are clear and quick to follow.",
        },
        {
          role: "Taxi Driver",
          text: "I carry out photo missions to verify the presence of phone brand advertisements in kiosks. It's flexible and pays quickly.",
        },
        {
          role: "Large Retail Employee",
          text: "I gathered customer opinions on the new rice packs in my store. It gives me a nice supplementary salary.",
        },
        {
          role: "Housewife",
          text: "I helped check the quality and price of dairy products in my neighborhood. It allowed me to earn extra money without having to travel far.",
        },
        {
          role: "Bank Employee",
          text: "I participated in missions to collect information on banking services in several agencies. It's a good complement to my work.",
        },
        {
          role: "Market Vendor",
          text: "I take photos and report on product availability in my market. It's simple and fits my schedule.",
        },
        {
          role: "IT Student",
          text: "I did missions to verify the presence of electronic products in shops. The app is intuitive and the missions are well-paid.",
        },
        {
          role: "Bus Driver",
          text: "I do missions to check advertisements in bus stations during my breaks. It's flexible and helps earn an extra income.",
        },
        {
          role: "Secretary",
          text: "I carried out customer satisfaction surveys in local shops. It was interesting and improved my sense of observation.",
        },
      ]
    },
    ...
    ctaSimulator: {
      month: "a month",
      perWeekFixed: "per week, job average 7€",
    },
  ...
  terms_of_use: {
    ...
    welcome_to_tadaiq:
      'These Contributor Terms (the "Agreement") govern your participation as a Contributor ("you", "your") on the Tada platform (the "Platform"), operated by TadaIQ ("Tada", "we", "our").',
    please_read_these_terms_carefully:
      'By accessing and using the Platform, submitting data, and performing tasks (each a "Task"), you agree to be bound by this Agreement, our Terms of Use, Privacy Policy, and Cookie Policy.',
    quick_navigation: "Quick Navigation",

    // Navigation items
    definitions: "General Terms",
    acceptance: "Contributor Eligibility",
    eligibility: "Independent Contractor",
    account_security: "Tasks and Validation",
    services: "Payment Terms",
    contributor_obligations: "Data Collection and Rights",
    client_obligations: "Code of Conduct",
    intellectual_property: "Task Review and Appeals",
    payments: "Fraud Prevention",
    privacy: "Safety and Risk",
    disclaimers: "Privacy and Data Use",
    liability: "Dispute Resolution",
    indemnification: "Miscellaneous",

    // Section 1: General Terms
    section_1_title: "1. General Terms",
    tadaiq_definition_title: "1.1 Scope of Agreement",
    tadaiq_definition_content:
      'These Contributor Terms (the "Agreement") govern your participation as a Contributor ("you", "your") on the Tada platform (the "Platform"), operated by TadaIQ ("Tada", "we", "our").',
    platform_definition_title: "1.2 Binding Agreement",
    platform_definition_content:
      'By accessing and using the Platform, submitting data, and performing tasks (each a "Task"), you agree to be bound by this Agreement, our Terms of Use, Privacy Policy, and Cookie Policy.',

    // Section 2: Contributor Eligibility
    section_2_title: "2. Contributor Eligibility",
    acceptance_content:
      "You must be at least 18 years old or have reached the age of majority in your country of residence.",
    ...
    section_3_title: "3. Independent Contractor Relationship",
    section_3_1_title: "3.1 Independent Status",
    section_3_1_content:
      "You are an independent contractor. Nothing in this Agreement creates an employment, partnership, joint venture, or agency relationship between you and Tada.",
    section_3_2_title: "3.2 Tax Responsibilities",
    section_3_2_content:
      "You are solely responsible for all taxes, social contributions, licenses, permits, and obligations arising from your participation.",

    // Section 4: Tasks and Validation
    section_4_title: "4. Tasks and Validation",
    section_4_1_title: "4.1 Task Completion",
    section_4_1_content:
      "You may complete Tasks made available via the Platform. Task details, requirements, and expected deliverables will be specified on the Platform.",
    section_4_2_title: "4.2 Validation Process",
    section_4_2_content:
      "Tada reserves the right to validate submitted data through manual quality review, AI systems, or both.",
    section_4_3_title: "4.3 Payment Eligibility",
    section_4_3_content:
      "Only Tasks completed and validated by Tada will be eligible for payment.",

    // Section 5: Payment Terms
    section_5_title: "5. Payment Terms",
    section_5_1_title: "5.1 Payment Structure",
    section_5_1_content:
      "Payment is offered per validated Task. The payable amount and available payment methods will be indicated on the Platform.",
    section_5_1_important:
      "Payments are subject to quality validation, fraud prevention checks, and minimum payment thresholds.",
    section_5_2_title: "5.2 Payment Processing",
    section_5_2_content:
      "Delays may occur if a submission is under review or suspected of non-compliance.",
    section_5_2_important:
      "You are solely responsible for any fees charged by your payment provider.",

    // Section 6: Data Collection, Ownership, and Rights
    section_6_title: "6. Data Collection, Ownership, and Rights",
    section_6_intro:
      "By completing a Task, you grant Tada full rights over your submitted data.",
    section_6_1_title: "6.1 Data Rights Grant",
    section_6_1_content:
      "By completing a Task, you grant Tada a non-exclusive, worldwide, perpetual, irrevocable, royalty-free, and transferable right to use, analyze, market, and distribute all submitted data, content, and materials.",
    section_6_2_title: "6.2 Rights Waiver",
    section_6_2_content:
      "You waive all moral rights, attribution rights, or claims relating to the data you submit.",
    section_6_3_title: "6.3 Data Types",
    section_6_3_content:
      "Collected data may include location, photos, videos, survey responses, and personal demographic information (e.g., education, employment, financial information), as detailed in our Privacy Policy.",

    // Section 7: Contributor Code of Conduct
    section_7_title: "7. Contributor Code of Conduct",
    section_7_intro:
      "As a Contributor, you agree to uphold high standards of conduct.",
    section_7_1_title: "7.1 Required Conduct",
    section_7_1_content:
      "Complete all Tasks truthfully and independently. Submit only authentic, accurate, and original data. Respect individuals, businesses, and institutions while working. Prioritize your safety and follow local laws. Never spoof location, falsify submissions, or use automated scripts.",
    section_7_6_title: "7.2 Prohibited Behavior",
    section_7_6_intro: "Prohibited behavior includes, but is not limited to:",
    section_7_6_item_1: "Sharing your account or device with others",
    section_7_6_item_2: "Operating multiple accounts",
    section_7_6_item_3:
      "Providing false, misleading, vulgar, hateful, or inappropriate content",
    section_7_6_item_4:
      "Engaging in harassment, threats, or disrespectful conduct toward any individual or Tada staff",
    section_7_6_item_5:
      "Using bots, macros, or non-human interactions to complete Tasks",

    // Section 8: Task Review and Rejection Appeals
    section_8_title: "8. Task Review and Rejection Appeals",
    section_8_1_title: "8.1 Quality Review",
    section_8_1_content: "All submitted Tasks are reviewed for quality.",
    section_8_2_title: "8.2 Rejection Feedback",
    section_8_2_content_1:
      "If a Task is rejected, you will receive feedback explaining the reason.",
    section_8_3_title: "8.3 Appeal Process",
    section_8_3_content:
      "You are entitled to one (1) appeal per rejected Task. Appeals must be submitted within 14 days of rejection.",
    section_8_4_title: "8.4 Final Decisions",
    section_8_4_content: "Decisions after appeal review are final.",

    // Section 9: Fraud Prevention and Account Termination
    section_9_title: "9. Fraud Prevention and Account Termination",
    section_9_1_title: "9.1 Investigation Rights",
    section_9_1_content_1:
      "Tada has the right to audit, investigate, and take action against any fraudulent activity.",
    section_9_1_content_2:
      "Grounds for immediate suspension or termination include (but are not limited to): Submission of false data, location spoofing, harassment or inappropriate behavior, violation of the Code of Conduct or this Agreement.",
    section_9_2_title: "9.2 Fraud Consequences",
    section_9_2_content_1:
      "In case of fraud, any unpaid balance may be forfeited.",

    // Section 10: Safety and Risk
    section_10_title: "10. Safety and Risk",
    section_10_intro: "Your safety is a top priority while completing Tasks.",
    section_10_compliance_title: "10.1 Safety Priority",
    section_10_compliance_content:
      "You must prioritize your safety when completing Tasks.",
    section_10_contributors_title: "10.2 Restricted Areas",
    section_10_contributors_content:
      "Do not complete any Tasks in areas where you feel unsafe or where local regulations restrict access.",
    section_10_clients_title: "10.3 Disclaimer",
    section_10_clients_content:
      "Tada is not liable for any injury, damage, or loss you may suffer while performing Tasks.",
    section_10_rights_title: "10.4 Assumption of Risk",
    section_10_rights_content:
      "You assume all risks associated with completing Tasks.",

    // Section 11: Privacy and Data Use
    section_11_title: "11. Privacy and Data Use",
    section_11_risk_title: "11.1 Governed by Privacy Policy",
    section_11_risk_content:
      "The collection, use, storage, and sharing of your data is governed by Tada’s Privacy Policy.",
    section_11_disclaimer_1:
      "By agreeing to these Terms, you also agree to Tada’s Privacy Policy.",
    section_11_disclaimer_2:
      "More information on data collected and its use can be found in the Privacy Policy.",

    // Section 12: Dispute Resolution and Governing Law
    section_12_title: "12. Dispute Resolution and Governing Law",
    section_12_1_title: "12.1 Governing Law",
    section_12_1_content:
      "This Agreement is governed by the laws of the Republic of Côte d'Ivoire.",
    section_12_2_title: "12.2 Arbitration",
    section_12_2_content:
      "Any dispute arising from this Agreement will be resolved by arbitration as described in the Terms of Use.",

    // Section 13: Miscellaneous
    section_13_title: "13. Miscellaneous",
    section_13_content_1:
      "Tada may update or amend this Agreement at any time by posting the updated version on the Platform. Continued use after changes constitutes acceptance.",
    section_13_content_2:
      "If any provision of this Agreement is found to be invalid or unenforceable, the remaining provisions shall remain in full force and effect. This Agreement constitutes the entire agreement between you and Tada regarding your participation as a Contributor.",

    // Final Message
    final_message_title: "Thank You for Being Part of Tada",
    final_message_content:
      "Thank you for being part of the Tada community. Your contributions are essential in building a better understanding of markets, communities, and societies across Africa and beyond. Together, we make local data visible, actionable, and powerful. We are proud to have you on this journey with us.",
  },

  privacy: {
    header: {
      title: "Privacy Policy",
      effectiveDate: "Effective Date: May 31, 2025",
    },
    introduction: {
      paragraph1:
    ...
    roles: {
      title: "Understand Your Role with Us",
      description:
    ...
    partI: {
      ...
      description:
        "Part I describes our general privacy practices that apply to everyone who uses Tada's services, whether as a Customer, Contributor, or Visitor.",
      scope: {
      ...
      collection: {
        ...
        provided: {
          ...
          profile: {
            title: "Profile and Demographics",
            description:
        ...
        automatic: {
          ...
          sensor: {
            title: "Sensor and Environment Data",
            description:
          ...
          logs: {
            title: "Log Files and Online Activity",
            description:
      ...
      howWeUse: {
        ...
        provide: {
          title: "Provide and Maintain the Service",
          description:
        ...
        verify: {
          title: "Verify Tasks and Prevent Fraud/Illegal Activity",
          description:
        ...
        communicate: {
          title: "Facilitate Communications and Support",
          description:
        ...
        personalize: {
          title: "Personalize Content and Advertising",
          description:
      ...
      sharing: {
        ...
        partners: {
          title: "With Our Partners and Affiliates",
          description:
        ...
        serviceProviders: {
          title: "With Service Providers and Advisors",
          description:
        ...
        legal: {
          title: "For Legal Compliance and Safety",
          description:
        ...
        aggregated: {
          title: "Aggregated or Anonymized Data",
          description:
      ...
      choices: {
        ...
        description:
          "We want you to have control over your personal information. Depending on your relationship with us (Contributor, Customer, or Visitor) and your location, you have various rights and choices regarding the data we have about you",
        access: {
          title: "Access, Correction, and Deletion of Account Information",
          description:
    ...
    europeanRights: {
      ...
      right1: {
        ...
        description:
          'You have the right to request confirmation of whether we are processing your data, and if so, to request a copy of the data and details about how we use it. This is often known as a "Data Subject Access Request."',
      },
      right2: {
        title: "Right to Rectification:",
        description:
          "You are entitled to request that we correct any inaccurate or incomplete personal data we hold about you. If you cannot correct it yourself through your account, you can ask us to correct it.",
      },
      right3: {
        title: "Right to Erasure:",
        description:
          'This is sometimes called the "right to be forgotten." You can ask us to delete or remove personal data in certain circumstances, for example, if it\'s no longer necessary for the purposes collected, or if you have withdrawn consent and we have no other legal basis to continue processing. Please note we might retain some information when permitted by law (such as to comply with legal obligations or for resolving disputes).',
      },
      right4: {
        title: "Right to Restrict Processing:",
        description:
          "You have the right to ask us to suspend the processing of some of your data (e.g., if you want us to establish its accuracy or the reason for processing it, or if you object to us processing it based on legitimate interests).",
      },
      right5: {
        title: "Right to Data Portability:",
        description:
          "In some cases, you can request a copy of your data in a commonly used, machine-readable format so that you can transmit it to another service provider. Where technically feasible, you can also ask us to send this data directly to another organization at your request.",
      },
      right6: {
    ...
    partII: {
      title: "Part II – Additional Terms for Customers (Clients)",
      description:
      ...
      clientAccount: {
        title: "Client Account and Login Data:",
        description:
      ...
      thirdPartyTools: {
        ...
        description:
          "We may integrate third-party tools into our Customer platform to facilitate communication and data analysis. For instance, we might use FullStory or similar tools to replay sessions (with appropriate security) to identify where clients might be encountering issues. We could also use collaboration tools that allow you to chat with our support or success team in real-time. Any data collected through those interactions will be used solely for assisting you and improving our services.",
      },
      salesCrm: {
        title: "Sales and CRM Data:",
        description:
          "In the course of our business, Tada maintains a database of current and prospective client contacts using Customer Relationship Management (CRM) software (for example, Salesforce or HubSpot). If you have interacted with our sales team or requested a demo or information, we may store your contact information and communication history in our CRM. We use this information to follow up on your inquiries, send proposals, and keep track of contract details. Our CRM and related communication systems (such as email via Google Workspace or Office 365) are accessible only by authorized Tada personnel and are protected by access controls.",
      },
      conflicts: {
        title: "Conflicts with Client Agreement:",
        description:
          "If you are a Customer who has signed a specific Master Services Agreement or Client Agreement with Tada, that agreement may contain additional provisions about data handling, which shall also apply. In the event of any conflict between such Client Agreement and this Privacy Policy about how we may use or share data, the terms of the Client Agreement will control to the extent permitted by law (for example, a Client Agreement might specify particular confidentiality obligations or usage rights for the data you obtain through our platform).",
      },
    },
    partIII: {
      title: "Part III – Additional Terms for Contributors",
      description:
      ...
      dataCategories: {
        ...
        usage: {
          title: "App Usage and Interaction Data:",
          description:
        ...
        language: {
          ...
          description:
            "We may collect your preferred language and other app settings. This is simply to localize content for you and present the app in the way that's most understandable. Lawful basis: Performance of contract (providing the service in your chosen language) and legitimate interest (enhancing usability).",
        },
        contacts: {
          title: "Contacts and Social Data (if provided):",
          description:
            "As mentioned, if you allow access to your phone contacts for referral programs, we collect that to facilitate invitations. If you link a social media account or provide a referral code to a friend, we track that linkage to provide rewards if applicable. Lawful basis: Consent (you opt in to these features) and legitimate interest (growing our community through referrals).",
        },
        payment: {
          title: "Payment and Financial Info:",
          description:
            "To pay you for your contributions, we collect the necessary payment details (such as mobile money account or other payout method, and possibly information needed for tax reporting, like your country or tax ID if earnings are substantial and local law requires it). We also generate records of transactions (tasks completed, amounts earned, payout dates). This information is used to compensate you and to comply with financial regulations (for example, keeping payment records for accounting and tax). Lawful basis: Performance of contract (paying you as promised) and legal obligations (financial record-keeping, tax compliance). For certain payout methods, if we are required by law or by our payment processors, we might require identity verification – this falls under legal obligation as well (e.g., anti-money laundering laws).",
        },
      },
      summary:
    ...
    partIV: {
      ...
      disclosure: {
        title: "Categories of Personal Information Disclosed or Sold",
        description:
      ...
      right1: {
        title: "Right to Know:",
        description:
          "You have the right to request that we disclose what personal information we collect, use, disclose, and sell. You may request that we provide you with the specific pieces of personal information we have about you, or the categories of information, sources, purposes, and third parties involved. Upon a verifiable request, and within the timeframe allowed by law, we will provide the requested information for the period required by law (typically the past 12 months).",
      },
      right2: {
        title: "Right to Correct:",
        description:
          "You have the right to request that we correct any inaccurate personal information we maintain about you. If you become aware that any of your information is incorrect, please let us know, and we will verify and correct it as required.",
      },
      right3: {
    ...
    contact: {
      ...
      email: {
        title: "By Email:",
        note: "This is the fastest way to get a response regarding your privacy questions.",
      },
      mail: {
        title: "By Mail:",
        address: {
          line1: "Tada Sarl – Privacy Office",
          line2: "Abidjan, Plateau Indenié",
          line3: "Côte d'Ivoire",
        },
        note: '(Please include "Attn: Privacy" or "Attn: Legal" in your letter so it gets to the right team. If you are writing from outside Côte d\'Ivoire, please note that international mail may take some time to arrive.)',
      },
    },
    footer: {
      paragraph1:

...
import { submitMissionForValidationAction } from "@/actions/missions/submit-mission-for-validation.action";
...
export function UpdateMissionForm({
  ...
  const updateMission = useAction(submitMissionForValidationAction, {
    onSuccess: ({ data }) => {
      // setMission(data!);

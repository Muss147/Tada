...
var SelectTrigger = React.forwardRef(function (_a, ref) {
    var className = _a.className, children = _a.children, _b = _a.hideIcon, hideIcon = _b === void 0 ? false : _b, props = __rest(_a, ["className", "children", "hideIcon"]);
    return (<SelectPrimitive.Trigger ref={ref} className={cn("!flex h-9 w-full items-center justify-between whitespace-nowrap border border-border bg-transparent px-3 py-5 text-sm font-normal placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 rounded-sm", className)} {...props}>
    <span className="line-clamp-1">{children}</span>
    {!hideIcon && (<div className="h-4 w-4">
...
var SelectItem = React.forwardRef(function (_a, ref) {
    ...
    return (<SelectPrimitive.Item ref={ref} className={cn("relative flex w-full cursor-default select-none items-center py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)} {...props}>

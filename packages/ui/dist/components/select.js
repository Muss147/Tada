...
var SelectTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (_jsxs(SelectPrimitive.Trigger, __assign({ ref: ref, className: cn("!flex h-9 w-full items-center justify-between whitespace-nowrap border border-border bg-transparent px-3 py-5 text-sm font-normal placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 rounded-sm", className) }, props, { children: [_jsx("span", { className: "line-clamp-1", children: children }), !hideIcon && (_jsx("div", { className: "h-4 w-4", children: _jsx(SelectPrimitive.Icon, { asChild: true, children: _jsx(ChevronDownIcon, { className: "h-4 w-4" }) }) }))] })));
});

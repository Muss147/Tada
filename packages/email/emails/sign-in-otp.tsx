...
const translations = {
  fr: {
    preview: "Votre code de connexion Tada",
    title: "Votre code de connexion",
    description:
      "Voici votre code de connexion pour accéder à votre compte Tada :",
    otpLabel: "Code de connexion",
    disclaimer:
      "Ce code expirera dans 5 minutes. Si vous n'avez pas demandé ce code, vous pouvez ignorer cet email en toute sécurité.",
    footer: "© {year} Tada. Tous droits réservés.",
  },
  en: {
    preview: "Your Tada sign-in code",
    title: "Your sign-in code",
    description: "Here's your code to sign in to your Tada account:",
...
export const SignInOTPEmail = ({ otp, locale = "fr" }: SignInOTPProps) => {
  const t =
